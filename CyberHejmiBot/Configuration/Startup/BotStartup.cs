...
{
    interface IBotStartup
    {
        Task Init();
    }

    internal class BotStartup: IBotStartup
    {
        ...
        public BotStartup(DiscordSocketClient client, TextCommandHandler commandHandler, ILogger logger, BotSettings botSettings, IEventListener eventListener)
        {
            Client = client;
